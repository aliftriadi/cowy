...
import bikea.onexf.python.CameraActivity;
...
public class CameraRulerView extends View {
    ...
    public CameraActivity.Status ctxStatus;
    public Paint paint = new Paint();
    public Paint referencePaint = new Paint();
    public Paint warningPaint = new Paint();
    public Paint touchPointPaint = new Paint();
    public Paint referenceTouchPointPaint = new Paint();
    public String unitOfMeasurement = getResources().getString(R.string.pref_uom_default);
    public Shape measure = null;
    public Shape reference = new Circle(new Point(400, 400), 100);
    public float scale = 1;
    float touchOffsetX;
    float touchOffsetY;
    float[] points = new float[16];
    public int activeTouchpoint = -1; // -1 when inactive, 0 for circle center, 1 for circle radius
    ...
    public void executeTouch(MotionEvent event) {
     ...
     */
    public int clickInTouchpoint(MotionEvent event) {
